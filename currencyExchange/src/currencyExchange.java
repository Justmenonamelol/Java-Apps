...
do {
    ...
    switch (MenuList) {
        case 1:
            ...
            break;
        case 2:
            System.out.print("Enter The amount of how many Pounds to Dollars:");
            Value = keyboard.nextLong(); // Amount of the Currency(In this case: Pound);
            result = Value * 1.28;
            ...
            break;
        case 3:
            System.out.print("Enter The amount of how many Pounds to Yen:");
            Value = keyboard.nextLong(); // AAmount of the Currency(In this case: Pound);
